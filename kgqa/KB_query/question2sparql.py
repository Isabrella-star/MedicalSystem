...
if __name__ == '__main__':
    q2s = Question2Sparql(['E:/MedicalNew/kgqa/KB_query/dict/jibing_pos_name.txt', 'E:/Medical/kgqa/KB_query/dict/drug_pos_name.txt', 'E:/Medical/kgqa/KB_query/dict/symptom_pos.txt'])
    #question = '喉插管损伤有什么症状？'
